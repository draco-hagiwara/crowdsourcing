<?php /* Smarty version 3.1.27, created on 2015-12-15 18:28:46
         compiled from "/home/cs/www/cs.com.dev/modules/writer/views/contents/writer/search_list/detail.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:847738496566fdd4eb7c8e1_93034917%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4ac7033722dfb146d72fac599339bcb71dbc929d' => 
    array (
      0 => '/home/cs/www/cs.com.dev/modules/writer/views/contents/writer/search_list/detail.tpl',
      1 => 1450171597,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '847738496566fdd4eb7c8e1_93034917',
  'variables' => 
  array (
    'order_no' => 0,
    'job_cnt' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_566fdd4ec814c8_98353417',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_566fdd4ec814c8_98353417')) {
function content_566fdd4ec814c8_98353417 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '847738496566fdd4eb7c8e1_93034917';
?>
...
<ul class="nav nav-tabs">
  <?php if ($_smarty_tpl->tpl_vars['order_no']->value == '00') {?><li role="presentation" class="active"><?php } else { ?><li role="presentation"><?php }?><a href="/writer/search_list/detail00">仕事概要</a></li>
  <?php if ($_smarty_tpl->tpl_vars['order_no']->value == '01') {?><li role="presentation" class="active"><?php } else { ?><li role="presentation"><?php }?><a href="/writer/search_list/detail01/">記事詳細１</a></li>
  <?php if ($_smarty_tpl->tpl_vars['job_cnt']->value == 2) {?>
    <?php if ($_smarty_tpl->tpl_vars['order_no']->value == '02') {?><li role="presentation" class="active"><?php } else { ?><li role="presentation"><?php }?><a href="/writer/search_list/detail02/">記事詳細２</a></li>
  <?php }?>
  <?php if ($_smarty_tpl->tpl_vars['job_cnt']->value == 3) {?>
    <?php if ($_smarty_tpl->tpl_vars['order_no']->value == '02') {?><li role="presentation" class="active"><?php } else { ?><li role="presentation"><?php }?><a href="/writer/search_list/detail02/">記事詳細２</a></li>
    <?php if ($_smarty_tpl->tpl_vars['order_no']->value == '03') {?><li role="presentation" class="active"><?php } else { ?><li role="presentation"><?php }?><a href="/writer/search_list/detail03/">記事詳細３</a></li>
  <?php }?>
</ul>

<div class="jumbotron">
<?php if ($_smarty_tpl->tpl_vars['order_no']->value == '00') {?>
<?php echo form_open('search_list/data_entry/','name="SearchlistForm" class="form-horizontal"');?>
...
echo form_dropdown('pj_mm_rank_id',$_smarty_tpl->tpl_vars['options_pj_mm_rank_id']->value,$_tmp1);?>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-4">
      ...
      <?php echo form_hidden('pj_mm_rank_id',$_smarty_tpl->tpl_vars['order_info']->value['pj_mm_rank_id']);?>

      <?php echo form_hidden('pj_char_cnt',$_smarty_tpl->tpl_vars['order_info']->value['pj_char_cnt']);?>
...
】
  ...
  <div class="form-group">
    ...
    <div class="col-sm-4">
      ...
      <?php echo form_hidden('pj_start_time',$_smarty_tpl->tpl_vars['order_info']->value['pj_start_time']);?>
...
$_smarty_tpl->tpl_vars['attr_sub']->value['type'] = 'submit';?>
      <?php $_smarty_tpl->createLocalArrayVariable('attr_sub', null, 0);
$_smarty_tpl->tpl_vars['attr_sub']->value['value'] = '_fav';?>
      <?php echo form_button($_smarty_tpl->tpl_vars['attr_sub']->value,'「気になるリスト」へ追加する',$_smarty_tpl->tpl_vars['js']->value);?>
