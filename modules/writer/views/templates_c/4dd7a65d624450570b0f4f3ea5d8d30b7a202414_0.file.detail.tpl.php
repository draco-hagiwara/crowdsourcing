<?php /* Smarty version 3.1.27, created on 2015-12-10 17:24:58
         compiled from "/home/cs/www/cs.com.dev/application/views/contents/writer/search_genre/detail.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:1598141572566936da858465_36503803%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4dd7a65d624450570b0f4f3ea5d8d30b7a202414' => 
    array (
      0 => '/home/cs/www/cs.com.dev/application/views/contents/writer/search_genre/detail.tpl',
      1 => 1449735885,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1598141572566936da858465_36503803',
  'variables' => 
  array (
    'order_no' => 0,
    'job_cnt' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_566936da948b58_51862302',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_566936da948b58_51862302')) {
function content_566936da948b58_51862302 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '1598141572566936da858465_36503803';
?>
...
<ul class="nav nav-tabs">
  <?php if ($_smarty_tpl->tpl_vars['order_no']->value == '00') {?><li role="presentation" class="active"><?php } else { ?><li role="presentation"><?php }?><a href="/search_genre/detail00">仕事概要</a></li>
  <?php if ($_smarty_tpl->tpl_vars['order_no']->value == '01') {?><li role="presentation" class="active"><?php } else { ?><li role="presentation"><?php }?><a href="/search_genre/detail01/">記事詳細１</a></li>
  <?php if ($_smarty_tpl->tpl_vars['job_cnt']->value == 2) {?>
    <?php if ($_smarty_tpl->tpl_vars['order_no']->value == '02') {?><li role="presentation" class="active"><?php } else { ?><li role="presentation"><?php }?><a href="/search_genre/detail02/">記事詳細２</a></li>
  <?php }?>
  <?php if ($_smarty_tpl->tpl_vars['job_cnt']->value == 3) {?>
    <?php if ($_smarty_tpl->tpl_vars['order_no']->value == '02') {?><li role="presentation" class="active"><?php } else { ?><li role="presentation"><?php }?><a href="/search_genre/detail02/">記事詳細２</a></li>
    <?php if ($_smarty_tpl->tpl_vars['order_no']->value == '03') {?><li role="presentation" class="active"><?php } else { ?><li role="presentation"><?php }?><a href="/search_genre/detail03/">記事詳細３</a></li>
  <?php }?>
</ul>
...
<?php echo form_open('search_genre/data_entry/','name="OrderForm" class="form-horizontal"');?>
...
<?php echo form_open('search_genre/data_order/','name="OrderForm" class="form-horizontal"');?>
