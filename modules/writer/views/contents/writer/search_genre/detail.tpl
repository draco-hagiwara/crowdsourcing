...
<ul class="nav nav-tabs">
  {if $order_no == '00'}<li role="presentation" class="active">{else}<li role="presentation">{/if}<a href="/writer/search_genre/detail00">仕事概要</a></li>
  {if $order_no == '01'}<li role="presentation" class="active">{else}<li role="presentation">{/if}<a href="/writer/search_genre/detail01/">記事詳細１</a></li>
  {if $job_cnt == 2}
    {if $order_no == '02'}<li role="presentation" class="active">{else}<li role="presentation">{/if}<a href="/writer/search_genre/detail02/">記事詳細２</a></li>
  {/if}
  {if $job_cnt == 3}
    {if $order_no == '02'}<li role="presentation" class="active">{else}<li role="presentation">{/if}<a href="/writer/search_genre/detail02/">記事詳細２</a></li>
    {if $order_no == '03'}<li role="presentation" class="active">{else}<li role="presentation">{/if}<a href="/writer/search_genre/detail03/">記事詳細３</a></li>
  {/if}
</ul>
