<?php /* Smarty version 3.1.27, created on 2015-10-26 21:47:26
         compiled from "/home/cs/www/cs.com.dev/modules/client/views/contents/client/entrylist/detail.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:169483000562e20de9ab226_13931975%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4c4439c85e6fba2e96436bf39fbe236e2fd97f89' => 
    array (
      0 => '/home/cs/www/cs.com.dev/modules/client/views/contents/client/entrylist/detail.tpl',
      1 => 1445863638,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '169483000562e20de9ab226_13931975',
  'variables' => 
  array (
    'entry_no' => 0,
    'entry_info' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_562e20deb46031_20246356',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_562e20deb46031_20246356')) {
function content_562e20deb46031_20246356 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '169483000562e20de9ab226_13931975';
?>
...
<ul class="nav nav-tabs">
  <?php if ($_smarty_tpl->tpl_vars['entry_no']->value == '00') {?><li role="presentation" class="active"><?php } else { ?><li role="presentation"><?php }?><a href="/client/entrylist/detail00">申請内容【必須】</a></li>
  <?php if ($_smarty_tpl->tpl_vars['entry_no']->value == '01') {?><li role="presentation" class="active"><?php } else { ?><li role="presentation"><?php }?><a href="/client/entrylist/detail01/">申請案件１【必須】</a></li>
  <?php if ($_smarty_tpl->tpl_vars['entry_no']->value == '02') {?><li role="presentation" class="active"><?php } else { ?><li role="presentation"><?php }?><a href="/client/entrylist/detail02/">申請案件２【任意】</a></li>
  <?php if ($_smarty_tpl->tpl_vars['entry_no']->value == '03') {?><li role="presentation" class="active"><?php } else { ?><li role="presentation"><?php }?><a href="/client/entrylist/detail03/">申請案件３【任意】</a></li>
</ul>
...
<?php echo form_open('entrylist/data_entry/','name="EntryorderForm" class="form-horizontal"');?>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-4">
		  <?php ob_start();
echo $_smarty_tpl->tpl_vars['entry_info']->value['pe_status'];
$_tmp1=ob_get_clean();
echo form_dropdown('pe_status',$_smarty_tpl->tpl_vars['options_entry_status']->value,$_tmp1);?>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-9">
      <?php echo form_input('pe_entry_title',set_value('pe_entry_title',$_smarty_tpl->tpl_vars['entry_info']->value['pe_entry_title']),'class="form-control" placeholder="タイトル（表示件名）を入力してください"');?>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-9">
		  <?php echo form_dropdown('pe_genre01',$_smarty_tpl->tpl_vars['options_genre_list']->value,set_value('pe_genre01',$_smarty_tpl->tpl_vars['entry_info']->value['pe_genre01']));?>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-9">
      <?php echo form_input('pe_title',set_value('pe_title',$_smarty_tpl->tpl_vars['entry_info']->value['pe_title']),'class="form-control" placeholder="案件申請：タイトルを入力してください"');?>
...
$_smarty_tpl->tpl_vars['attr']->value['rows'] = 5;?>
      <?php echo form_textarea($_smarty_tpl->tpl_vars['attr']->value,set_value('pe_work',$_smarty_tpl->tpl_vars['entry_info']->value['pe_work']),'class="form-control" placeholder="案件申請：内容を入力してください"');?>
...
$_smarty_tpl->tpl_vars['attr']->value['name'] = 'pe_notice';?>
      <?php $_smarty_tpl->createLocalArrayVariable('attr', null, 0);
$_smarty_tpl->tpl_vars['attr']->value['rows'] = 5;?>
      <?php echo form_textarea($_smarty_tpl->tpl_vars['attr']->value,set_value('pe_notice',$_smarty_tpl->tpl_vars['entry_info']->value['pe_notice']),'class="form-control" placeholder="案件申請：注意事項を入力してください"');?>
...
$_smarty_tpl->tpl_vars['attr']->value['name'] = 'pe_example';?>
      <?php $_smarty_tpl->createLocalArrayVariable('attr', null, 0);
$_smarty_tpl->tpl_vars['attr']->value['rows'] = 5;?>
      <?php echo form_textarea($_smarty_tpl->tpl_vars['attr']->value,set_value('pe_example',$_smarty_tpl->tpl_vars['entry_info']->value['pe_example']),'class="form-control" placeholder="案件申請：例文を入力してください"');?>
...
$_smarty_tpl->tpl_vars['attr']->value['name'] = 'pe_other';?>
      <?php $_smarty_tpl->createLocalArrayVariable('attr', null, 0);
$_smarty_tpl->tpl_vars['attr']->value['rows'] = 5;?>
      <?php echo form_textarea($_smarty_tpl->tpl_vars['attr']->value,set_value('pe_other',$_smarty_tpl->tpl_vars['entry_info']->value['pe_other']),'class="form-control" placeholder="案件申請：その他を入力してください"');?>
...
$_smarty_tpl->tpl_vars['attr']->value['name'] = 'pe_addwork';?>
      <?php $_smarty_tpl->createLocalArrayVariable('attr', null, 0);
$_smarty_tpl->tpl_vars['attr']->value['rows'] = 5;?>
      <?php echo form_textarea($_smarty_tpl->tpl_vars['attr']->value,set_value('pe_addwork',$_smarty_tpl->tpl_vars['entry_info']->value['pe_addwork']),'class="form-control" placeholder="「日付」+「追加内容」で分かりやすく入力してください"');?>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-4">
      <?php echo form_input('pe_word_tanka',set_value('pe_word_tanka',$_smarty_tpl->tpl_vars['entry_info']->value['pe_word_tanka']),'class="form-control" placeholder="個別文字単価指定を入力してください"');?>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-4">
      <?php echo form_input('pe_open_date',set_value('pe_open_date',$_smarty_tpl->tpl_vars['entry_info']->value['pe_open_date']),'class="form-control" placeholder="「20xx-xx-xx」の形式で入力してください"');?>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-4">
      <?php echo form_input('pe_delivery_date',set_value('pe_delivery_date',$_smarty_tpl->tpl_vars['entry_info']->value['pe_delivery_date']),'class="form-control" placeholder="「20xx-xx-xx」の形式で入力してください"');?>
...
$_smarty_tpl->tpl_vars['attr']->value['name'] = 'pe_comment';?>
      <?php $_smarty_tpl->createLocalArrayVariable('attr', null, 0);
$_smarty_tpl->tpl_vars['attr']->value['rows'] = 5;?>
      <?php echo form_textarea($_smarty_tpl->tpl_vars['attr']->value,set_value('pe_comment',$_smarty_tpl->tpl_vars['entry_info']->value['pe_comment']),'class="form-control"');?>
  ...
  <?php if (isset($_smarty_tpl->tpl_vars['entry_info']->value['pe_reason'])) {?>
    <div class="form-group">
    <label for="pe_reason" class="col-sm-3 control-label">非承認 理由</label>
    <div class="col-sm-9">
      <?php echo $_smarty_tpl->tpl_vars['entry_info']->value['pe_reason'];?>
...
<?php echo form_open('entrylist/data_entry/','name="EntryorderForm" class="form-horizontal"');?>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-9">
		  <?php echo form_dropdown('pei_status',$_smarty_tpl->tpl_vars['options_pei_status']->value,set_value('pei_status',$_smarty_tpl->tpl_vars['entry_info']->value['pei_status']));?>
...
" class="col-sm-3 control-label">タイトル：必須ワード指定 <?php echo $_smarty_tpl->tpl_vars['t_num']->value;?>
    ...
    <div class="col-sm-9">
      <?php echo form_input($_smarty_tpl->tpl_vars['t_keywd_num']->value,set_value($_smarty_tpl->tpl_vars['t_keywd_num']->value,$_smarty_tpl->tpl_vars['entry_info']->value[$_smarty_tpl->tpl_vars['t_keywd_num']->value]),'class="form-control" placeholder="タイトルに使用するキーワードを指定してください。100文字以内。"');?>
...
" class="col-sm-3 control-label">最低 使用回数</label>
    <div class="col-sm-3">
      <?php echo form_input($_smarty_tpl->tpl_vars['t_count_min']->value,set_value($_smarty_tpl->tpl_vars['t_count_min']->value,$_smarty_tpl->tpl_vars['entry_info']->value[$_smarty_tpl->tpl_vars['t_count_min']->value]),'class="form-control" placeholder="最低 使用回数"');?>
...
" class="col-sm-3 control-label">最大 使用回数</label>
    <div class="col-sm-3">
      <?php echo form_input($_smarty_tpl->tpl_vars['t_count_max']->value,set_value($_smarty_tpl->tpl_vars['t_count_max']->value,$_smarty_tpl->tpl_vars['entry_info']->value[$_smarty_tpl->tpl_vars['t_count_max']->value]),'class="form-control" placeholder="最大 使用回数"');?>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-3">
      <?php echo form_input('pei_t_char_min',set_value('pei_t_char_min',$_smarty_tpl->tpl_vars['entry_info']->value['pei_t_char_min']),'class="form-control" placeholder="最低 使用文字数"');?>
    ...
    <div class="col-sm-3">
      <?php echo form_input('pei_t_char_max',set_value('pei_t_char_max',$_smarty_tpl->tpl_vars['entry_info']->value['pei_t_char_max']),'class="form-control" placeholder="最大 使用文字数"');?>
...
" class="col-sm-3 control-label">本文：必須ワード指定 <?php echo $_smarty_tpl->tpl_vars['b_num']->value;?>
    ...
    <div class="col-sm-9">
      <?php echo form_input($_smarty_tpl->tpl_vars['b_keywd_num']->value,set_value($_smarty_tpl->tpl_vars['b_keywd_num']->value,$_smarty_tpl->tpl_vars['entry_info']->value[$_smarty_tpl->tpl_vars['b_keywd_num']->value]),'class="form-control" placeholder="本文に使用するキーワードを指定してください。100文字以内。"');?>
...
" class="col-sm-3 control-label">最低 使用回数</label>
    <div class="col-sm-3">
      <?php echo form_input($_smarty_tpl->tpl_vars['b_count_min']->value,set_value($_smarty_tpl->tpl_vars['b_count_min']->value,$_smarty_tpl->tpl_vars['entry_info']->value[$_smarty_tpl->tpl_vars['b_count_min']->value]),'class="form-control" placeholder="最低 使用回数"');?>
...
" class="col-sm-3 control-label">最大 使用回数</label>
    <div class="col-sm-3">
      <?php echo form_input($_smarty_tpl->tpl_vars['b_count_max']->value,set_value($_smarty_tpl->tpl_vars['b_count_max']->value,$_smarty_tpl->tpl_vars['entry_info']->value[$_smarty_tpl->tpl_vars['b_count_max']->value]),'class="form-control" placeholder="最大 使用回数"');?>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-3">
      <?php echo form_input('pei_b_char_min',set_value('pei_b_char_min',$_smarty_tpl->tpl_vars['entry_info']->value['pei_b_char_min']),'class="form-control" placeholder="最低 使用文字数"');?>
    ...
    <div class="col-sm-3">
      <?php echo form_input('pei_b_char_max',set_value('pei_b_char_max',$_smarty_tpl->tpl_vars['entry_info']->value['pei_b_char_max']),'class="form-control" placeholder="最大 使用文字数"');?>
...
$_smarty_tpl->tpl_vars['attr']->value['name'] = 'pei_work';?>
      <?php $_smarty_tpl->createLocalArrayVariable('attr', null, 0);
$_smarty_tpl->tpl_vars['attr']->value['rows'] = 5;?>
      <?php echo form_textarea($_smarty_tpl->tpl_vars['attr']->value,set_value('pei_work',$_smarty_tpl->tpl_vars['entry_info']->value['pei_work']),'class="form-control" placeholder="個別申請：内容を入力してください"');?>
...
$_smarty_tpl->tpl_vars['attr']->value['name'] = 'pei_notice';?>
      <?php $_smarty_tpl->createLocalArrayVariable('attr', null, 0);
$_smarty_tpl->tpl_vars['attr']->value['rows'] = 5;?>
      <?php echo form_textarea($_smarty_tpl->tpl_vars['attr']->value,set_value('pei_notice',$_smarty_tpl->tpl_vars['entry_info']->value['pei_notice']),'class="form-control" placeholder="個別申請：注意事項を入力してください"');?>
...
$_smarty_tpl->tpl_vars['attr']->value['name'] = 'pei_example';?>
      <?php $_smarty_tpl->createLocalArrayVariable('attr', null, 0);
$_smarty_tpl->tpl_vars['attr']->value['rows'] = 5;?>
      <?php echo form_textarea($_smarty_tpl->tpl_vars['attr']->value,set_value('pei_example',$_smarty_tpl->tpl_vars['entry_info']->value['pei_example']),'class="form-control" placeholder="個別申請：例文を入力してください"');?>
...
$_smarty_tpl->tpl_vars['attr']->value['name'] = 'pei_other';?>
      <?php $_smarty_tpl->createLocalArrayVariable('attr', null, 0);
$_smarty_tpl->tpl_vars['attr']->value['rows'] = 5;?>
      <?php echo form_textarea($_smarty_tpl->tpl_vars['attr']->value,set_value('pei_other',$_smarty_tpl->tpl_vars['entry_info']->value['pei_other']),'class="form-control" placeholder="個別申請：その他を入力してください"');?>
...
$_smarty_tpl->tpl_vars['attr']->value['name'] = 'pei_addwork';?>
      <?php $_smarty_tpl->createLocalArrayVariable('attr', null, 0);
$_smarty_tpl->tpl_vars['attr']->value['rows'] = 5;?>
      <?php echo form_textarea($_smarty_tpl->tpl_vars['attr']->value,set_value('pei_addwork',$_smarty_tpl->tpl_vars['entry_info']->value['pei_addwork']),'class="form-control" placeholder="個別申請：追加内容を入力してください"');?>
