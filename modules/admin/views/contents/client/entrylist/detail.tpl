...
<ul class="nav nav-tabs">
  ...
  {if $entry_no == '01'}<li role="presentation" class="active">{else}<li role="presentation">{/if}<a href="/client/entrylist/detail01/">申請案件１【必須】</a></li>
  {if $entry_no == '02'}<li role="presentation" class="active">{else}<li role="presentation">{/if}<a href="/client/entrylist/detail02/">申請案件２【任意】</a></li>
  {if $entry_no == '03'}<li role="presentation" class="active">{else}<li role="presentation">{/if}<a href="/client/entrylist/detail03/">申請案件３【任意】</a></li>
</ul>
...
{form_open('entrylist/data_entry/' , 'name="EntryorderForm" class="form-horizontal"')}
  ...
  <div class="form-group">
    ...
    <div class="col-sm-4">
		  {form_dropdown('pe_status', $options_entry_status, {$entry_info.pe_status})}
    </div>
  </div>
  <div class="form-group">
    <label for="pe_entry_title" class="col-sm-3 control-label">タイトル（表示件名）<font color=red>【必須】</font></label>
    <div class="col-sm-9">
      {form_input('pe_entry_title' , set_value('pe_entry_title', $entry_info.pe_entry_title) , 'class="form-control" placeholder="タイトル（表示件名）を入力してください"')}
  ...
  <div class="form-group">
    ...
    <div class="col-sm-9">
		  {form_dropdown('pe_genre01', $options_genre_list, set_value('pe_genre01', $entry_info.pe_genre01))}
    </div>
  </div>
  <div class="form-group">
    <label for="pe_title" class="col-sm-3 control-label">案件申請：タイトル<font color=red>【必須】</font></label>
    <div class="col-sm-9">
      {form_input('pe_title' , set_value('pe_title', $entry_info.pe_title) , 'class="form-control" placeholder="案件申請：タイトルを入力してください"')}
  ...
  <div class="form-group">
    ...
    <div class="col-sm-9">
      {$attr['name'] = 'pe_work'}
      {$attr['rows'] = 5}
      {form_textarea($attr , set_value('pe_work', $entry_info.pe_work) , 'class="form-control" placeholder="案件申請：内容を入力してください"')}
  ...
  <div class="form-group">
    ...
    <div class="col-sm-9">
      {$attr['name'] = 'pe_notice'}
      {$attr['rows'] = 5}
      {form_textarea($attr , set_value('pe_notice', $entry_info.pe_notice) , 'class="form-control" placeholder="案件申請：注意事項を入力してください"')}
  ...
  <div class="form-group">
    ...
    <div class="col-sm-9">
      ...
      {$attr['rows'] = 5}
      {form_textarea($attr , set_value('pe_example', $entry_info.pe_example) , 'class="form-control" placeholder="案件申請：例文を入力してください"')}
  ...
  <div class="form-group">
    ...
    <div class="col-sm-9">
      {$attr['name'] = 'pe_other'}
      {$attr['rows'] = 5}
      {form_textarea($attr , set_value('pe_other', $entry_info.pe_other) , 'class="form-control" placeholder="案件申請：その他を入力してください"')}
  ...
  <div class="form-group">
    ...
    <div class="col-sm-9">
      ...
      {$attr['rows'] = 5}
      {form_textarea($attr , set_value('pe_addwork', $entry_info.pe_addwork) , 'class="form-control" placeholder="「日付」+「追加内容」で分かりやすく入力してください"')}
  ...
  <div class="form-group">
    ...
    <div class="col-sm-4">
      {form_input('pe_word_tanka' , set_value('pe_word_tanka', $entry_info.pe_word_tanka) , 'class="form-control" placeholder="個別文字単価指定を入力してください"')}
  ...
  <div class="form-group">
    ...
    <div class="col-sm-4">
      {form_input('pe_open_date' , set_value('pe_open_date', $entry_info.pe_open_date) , 'class="form-control" placeholder="「20xx-xx-xx」の形式で入力してください"')}
  ...
  <div class="form-group">
    ...
    <div class="col-sm-4">
      {form_input('pe_delivery_date' , set_value('pe_delivery_date', $entry_info.pe_delivery_date) , 'class="form-control" placeholder="「20xx-xx-xx」の形式で入力してください"')}
  ...
  <div class="form-group">
    ...
    <div class="col-sm-9">
      ...
      {$attr['rows'] = 5}
      {form_textarea($attr , set_value('pe_comment', $entry_info.pe_comment) , 'class="form-control"')}
...
{form_open('entrylist/data_entry/' , 'name="EntryorderForm" class="form-horizontal"')}
  ...
  <div class="form-group">
    ...
    <div class="col-sm-9">
		  {form_dropdown('pei_status', $options_pei_status, set_value('pei_status', $entry_info.pei_status))}
    </div>
  </div>
  {/if}
  ...
  <div class="form-group">
    ...
    <div class="col-sm-3">
      {form_input('pei_t_char_min' , set_value('pei_t_char_min' , $entry_info.pei_t_char_min) , 'class="form-control" placeholder="最低 使用文字数"')}
    ...
    <div class="col-sm-3">
      {form_input('pei_t_char_max' , set_value('pei_t_char_max' , $entry_info.pei_t_char_max) , 'class="form-control" placeholder="最大 使用文字数"')}
  ...
  <div class="form-group">
    ...
    <div class="col-sm-3">
      {form_input('pei_b_char_min' , set_value('pei_b_char_min' , $entry_info.pei_b_char_min) , 'class="form-control" placeholder="最低 使用文字数"')}
    ...
    <div class="col-sm-3">
      {form_input('pei_b_char_max' , set_value('pei_b_char_max' , $entry_info.pei_b_char_max) , 'class="form-control" placeholder="最大 使用文字数"')}
  ...
  <div class="form-group">
    ...
    <div class="col-sm-9">
      {$attr['name'] = 'pei_work'}
      {$attr['rows'] = 5}
      {form_textarea($attr , set_value('pei_work', $entry_info.pei_work) , 'class="form-control" placeholder="個別申請：内容を入力してください"')}
  ...
  <div class="form-group">
    ...
    <div class="col-sm-9">
      ...
      {$attr['rows'] = 5}
      {form_textarea($attr , set_value('pei_notice', $entry_info.pei_notice) , 'class="form-control" placeholder="個別申請：注意事項を入力してください"')}
  ...
  <div class="form-group">
    ...
    <div class="col-sm-9">
      ...
      {$attr['rows'] = 5}
      {form_textarea($attr , set_value('pei_example', $entry_info.pei_example) , 'class="form-control" placeholder="個別申請：例文を入力してください"')}
  ...
  <div class="form-group">
    ...
    <div class="col-sm-9">
      {$attr['name'] = 'pei_other'}
      {$attr['rows'] = 5}
      {form_textarea($attr , set_value('pei_other', $entry_info.pei_other) , 'class="form-control" placeholder="個別申請：その他を入力してください"')}
  ...
  <div class="form-group">
    ...
    <div class="col-sm-9">
      ...
      {$attr['rows'] = 5}
      {form_textarea($attr , set_value('pei_addwork', $entry_info.pei_addwork) , 'class="form-control" placeholder="個別申請：追加内容を入力してください"')}
