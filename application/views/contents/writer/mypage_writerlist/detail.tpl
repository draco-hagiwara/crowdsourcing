...
{form_open('/writerlist/detail/' , 'name="writerDetailForm" class="form-horizontal"')}
  ...
  <div class="form-group">
    ...
    <div class="col-sm-4">
		  {form_dropdown('wr_status', $options_wr_status, {$writer_info.wr_status})}
    </div>
  </div>
  <div class="form-group">
    <label for="wr_name" class="col-sm-3 control-label">お名前<font color=red>【必須】</font></label>
    <div class="col-sm-4">
      {form_input('wr_name01' , {$writer_info.wr_name01} , 'class="form-control" placeholder="お名前姓を入力してください"')}
      {if form_error('wr_name01')}<span class="label label-danger">Error : </span><label><font color=red>{form_error('wr_name01')}</font></label>{/if}
    </div>
    <div class="col-sm-4">
      {form_input('wr_name02' , {$writer_info.wr_name02} , 'class="form-control" placeholder="お名前名を入力してください"')}
  ...
  <div class="form-group">
    ...
    <div class="col-sm-4">
      {form_input('wr_namekana01' , {$writer_info.wr_namekana01} , 'class="form-control" placeholder="お名前セイを入力してください"')}
    ...
    <div class="col-sm-4">
      {form_input('wr_namekana02' , {$writer_info.wr_namekana02} , 'class="form-control" placeholder="お名前メイを入力してください"')}
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
      {form_input('wr_nickname' , {$writer_info.wr_nickname} , 'class="form-control" placeholder="ニックネームを入力してください"')}
  ...
  <div class="form-group">
    ...
    <div class="col-sm-2">
      {form_input('wr_zip01' , {$writer_info.wr_zip01} , 'class="form-control" placeholder="郵便番号（3ケタ）"')}
      {if form_error('wr_zip01')}<span class="label label-danger">Error : </span><label><font color=red>{form_error('wr_zip01')}</font></label>{/if}
    </div>
    <div class="col-sm-2">
      {form_input('wr_zip02' , {$writer_info.wr_zip02} , 'class="form-control" placeholder="郵便番号（4ケタ）"')}
  ...
  <div class="form-group">
    ...
    <div class="col-sm-2 btn-lg">
      {form_dropdown('wr_pref', $options_pref, {$writer_info.wr_pref})}
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
      {form_input('wr_addr01' , {$writer_info.wr_addr01} , 'class="form-control" placeholder="市区町村を入力してください"')}
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
      {form_input('wr_addr02' , {$writer_info.wr_addr02} , 'class="form-control" placeholder="町名・番地を入力してください"')}
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
      {form_input('wr_buil' , {$writer_info.wr_buil} , 'class="form-control" placeholder="ビル・マンション名などを入力してください"')}
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
      {form_input('wr_email' , {$writer_info.wr_email} , 'class="col-sm-4 form-control" placeholder="メールアドレス（ログインID）を入力してください"')}
  ...
  <div class="form-group">
    <label for="wr_password" class="col-sm-3 control-label">パスワード<font color=red>【※注意】</font></label>
    <div class="col-sm-8">
      {form_password('wr_password' , '' , 'class="form-control" placeholder="パスワード変更時のみ入力　(半角英数字・記号：８文字以上)"')}
  ...
  <div class="form-group">
    <label for="retype_password" class="col-sm-3 control-label">パスワード再入力<font color=red>【※注意】</font></label>
    <div class="col-sm-8">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
      {form_input('wr_email_mobile' , {$writer_info.wr_email_mobile} , 'class="col-sm-4 form-control" placeholder="携帯メールアドレス（予備）を入力してください"')}
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
      {form_input('wr_tel' , {$writer_info.wr_tel} , 'class="form-control" placeholder="電話番号を入力してください"')}
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
      {form_input('wr_mobile' , {$writer_info.wr_mobile} , 'class="form-control" placeholder="携帯番号を入力してください"')}
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
      {form_checkbox('wr_mailmaga_flg','1',{$writer_info.wr_mailmaga_flg})}メルマガ配信を希望します
    </div>
    <div class="col-sm-1">
      <span class="label label-default">非表示</span>
    </div>
