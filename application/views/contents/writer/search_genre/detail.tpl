...
<ul class="nav nav-tabs">
  {if $order_no == '00'}<li role="presentation" class="active">{else}<li role="presentation">{/if}<a href="/search_genre/detail00">仕事内容【必須】</a></li>
  {if $order_no == '01'}<li role="presentation" class="active">{else}<li role="presentation">{/if}<a href="/search_genre/detail01/">仕事詳細１</a></li>
  {if $order_no == '02'}<li role="presentation" class="active">{else}<li role="presentation">{/if}<a href="/search_genre/detail02/">仕事詳細２</a></li>
  {if $order_no == '03'}<li role="presentation" class="active">{else}<li role="presentation">{/if}<a href="/search_genre/detail03/">仕事詳細３</a></li>
</ul>


<div class="jumbotron">
{if $order_no == '00'}
{form_open('search_genre/data_entry/' , 'name="OrderForm" class="form-horizontal"')}
...
{if $order_no != '00'}
{$num = $order_no}
{form_open('search_genre/data_order/' , 'name="OrderForm" class="form-horizontal"')}
