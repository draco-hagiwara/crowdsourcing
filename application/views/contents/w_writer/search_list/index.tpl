...
<h4>【仕事　検索】</h4>
{form_open('/search_list/search/' , 'name="searchForm" class="form-horizontal"')}
...
{form_open('/search_list/detail00/' , 'name="detailForm" class="form-horizontal"')}
		...
		<tbody>
			<tr>
				<td>
					...
					{else}
					<button type="submit" class="btn btn-success btn-xs" disabled="disabled" name="pjid_uniq" value="{$list.pj_id}">詳細</button>
					{/if}
				</td>
				<td>
