...
{form_open('entryclient/confirm/' , 'name="EntryclientForm" class="form-horizontal"')}
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
      {form_input('cl_email' , set_value('cl_email', '') , 'class="col-sm-4 form-control" placeholder="メールアドレス（代表）を入力してください"')}
  ...
  <div class="form-group">
    <label for="cm_password" class="col-sm-4 control-label">パスワード<font color=red>【必須】</font></label>
    <div class="col-sm-8">
